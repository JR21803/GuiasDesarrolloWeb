document.addEventListener("DOMContentLoaded", function(){
    ...
    function viewEstudiantes(){
        ...
        let toatlEstudiantes = arrayEstudiantes.length;
        if(toatlEstudiantes > 0){
            let carnet;
            let nombres;
            let apellidos;
            ...
            //utilizaremos un bucle for para recorrer arreglo estudiantes
            for (let i=0;i<arrayEstudiantes.length;i++){
                //accediendo a posiciones arreglo
